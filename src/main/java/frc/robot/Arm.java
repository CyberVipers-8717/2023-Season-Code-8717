...
public class Arm implements Sendable {
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addStringProperty("Target height", ArmPresets::getNameOfHeight, null);
    builder.addStringProperty("Target item", ArmPresets::getNameOfItem, null);
    builder.addDoubleArrayProperty("Target values", ArmPresets::getTargetPresets, null);
    builder.addBooleanArrayProperty("At target", () -> {
      double[] targets = ArmPresets.getTargetPresets();
  ...
  public static void runArm() {
    armTo(ArmPresets.getTargetPresets());
  }
  ...
  public static boolean armAtTargets() {
    return armAtPos(ArmPresets.getTargetPresets());
  }
